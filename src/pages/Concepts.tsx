...
const heroSlides = [
  {
    ...
    title: "Physical intelligence, designed for difficult places.",
  },
  {
    index: "002",
    ...
    src: `${import.meta.env.BASE_URL}concepts/torpedo-aircraft.jpg`,
    alt: "Concept torpedo-shaped aircraft shown in two configurations",
    title: "Lift, range, and autonomy in one silhouette.",
  },
  {
    index: "003",
  ...
  {
    index: "004",
    category: "Robotics / terrain",
    src: `${import.meta.env.BASE_URL}concepts/quadruped-robots.jpg`,
    alt: "Two quadruped robot concepts standing on a light surface",
    title: "Machines that move with the mission.",
  },
];
...
export default function Concepts() {
  ...
  return (
    <main className="concept-lab min-h-screen bg-[#06111f] pt-20 text-white">
      <section className="concept-hero section-padding relative overflow-hidden border-b border-white/10">
        <div className="concept-grid-bg absolute inset-0 pointer-events-none" />
        <div className="concept-glow concept-glow-one absolute pointer-events-none" />
        <div className="concept-glow concept-glow-two absolute pointer-events-none" />

        <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[0.88fr_1.12fr]">
          <AnimatedSection>
            <div className="flex flex-wrap items-center gap-x-5 gap-y-3">
              <p className="eyebrow text-[#67e8f9]">
                <Sparkles size={14} />
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-full border border-white/20 px-5 py-3 text-sm font-semibold text-white transition-colors hover:border-[#67e8f9] hover:text-[#67e8f9]"
              >
          ...
          <AnimatedSection delay={120}>
            <div className="concept-hero-shell relative overflow-hidden rounded-[2rem] border border-[#38BDF8]/30 bg-[#08111f] p-3 shadow-[0_30px_110px_rgba(14,165,233,0.18)]">
              <div className="concept-orbit concept-orbit-one absolute -right-20 -top-20 h-64 w-64 rounded-full border border-[#38BDF8]/20" />
              <div className="concept-orbit concept-orbit-two absolute -bottom-32 -left-20 h-80 w-80 rounded-full border border-[#67e8f9]/10" />
              <div className="relative aspect-[4/3] overflow-hidden rounded-[1.5rem] bg-[#06111f]">
                <div className="concept-image-grid absolute inset-0 pointer-events-none" />
                <div key={activeSlide.src} className="concept-hero-frame absolute inset-0">
                  <img
                    src={activeSlide.src}
                    alt={activeSlide.alt}
                    className="h-full w-full object-cover opacity-90"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#06111f] via-[#06111f]/10 to-[#06111f]/10" />
                </div>
              ...
              <div className="flex items-center justify-between gap-4 px-3 pb-2 pt-4 font-mono text-[10px] uppercase tracking-[0.1em] text-white/50">
                <div className="flex gap-5">
                  <span><b className="mr-1 text-[#67e8f9]">01</b> Sense</span>
                  <span><b className="mr-1 text-[#67e8f9]">02</b> Move</span>
                  <span><b className="mr-1 text-[#67e8f9]">03</b> Adapt</span>
                </div>
                <div className="flex items-center gap-2" aria-label="Concept slide controls">
                  {heroSlides.map((slide, index) => (
                    <button
                      key={slide.index}
                      type="button"
                      onClick={() => setActiveHero(index)}
                      aria-label={`Show future system ${slide.index}`}
                      aria-pressed={activeHero === index}
                      className={`concept-slide-dot h-1.5 rounded-full transition-all duration-500 ${activeHero === index ? "is-active" : ""}`}
                    />
                  ))}
                </div>
              </div>
      ...
      <div className="concept-marquee overflow-hidden border-b border-white/10 bg-[#081a2b] py-4" aria-label="Concept Lab system territories">
        <div className="concept-marquee-track flex min-w-max items-center font-mono text-[10px] uppercase tracking-[0.2em] text-white/50">
          <span>Robotics <i>✦</i> Aerial systems <i>✦</i> Marine autonomy <i>✦</i> Resilient infrastructure <i>✦</i> Physical intelligence <i>✦</i>&nbsp;</span>
          <span aria-hidden="true">Robotics <i>✦</i> Aerial systems <i>✦</i> Marine autonomy <i>✦</i> Resilient infrastructure <i>✦</i> Physical intelligence <i>✦</i>&nbsp;</span>
        </div>
      </div>

      <section className="concept-gallery section-padding border-t border-white/10 bg-[#071522]">
                  ...
                  <section>
                    <div className="mb-7 flex items-end justify-between gap-5 border-b border-white/10 pb-5">
                      <div className="flex items-start gap-4">
                        <span className="mt-1 inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#38BDF8]/25 bg-[#38BDF8]/10 text-[#67e8f9]">
                          <Icon size={18} />
                        </span>
                        <div>
                          <p className="eyebrow text-[#67e8f9]">{group.eyebrow}</p>
                          <h3 className="mt-2 text-3xl font-display font-extrabold text-white md:text-4xl">{group.title}</h3>
                        </div>
                      </div>
                      <span className="hidden font-mono text-[10px] uppercase tracking-[0.12em] text-white/35 sm:block">
                    ...
                    <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                      {group.concepts.map((concept, conceptIndex) => (
                        ...
                        >
                          <figure className="concept-card overflow-hidden rounded-2xl border border-white/10 bg-[#0a1d2f] transition-all duration-300 hover:-translate-y-1 hover:border-[#38BDF8]/50 hover:shadow-[0_20px_60px_rgba(14,165,233,0.16)]">
                            ...
                            <figcaption className="p-5">
                              <span className="mono text-[#67e8f9]">{concept.label}</span>
                              <strong className="mt-2 block text-xl font-display font-extrabold text-white">{concept.title}</strong>
                            </figcaption>
                          </figure>
                        </a>
                      ))}
      ...
      <section className="section-padding border-t border-white/10 bg-[#06111f]">
        <AnimatedSection>
          <div className="mx-auto flex max-w-5xl flex-col items-start justify-between gap-7 rounded-3xl border border-[#38BDF8]/25 bg-[#0a1d2f] p-7 shadow-[0_25px_80px_rgba(14,165,233,0.1)] md:flex-row md:items-center md:p-10">
            <div>
              <p className="mono mb-3 text-[#67e8f9]">From reference to reality</p>
              <h2 className="text-3xl font-display font-extrabold text-white md:text-4xl">A direction becomes real when the first prototype moves.</h2>
            </div>
            <Link to="/contact?inquiry=Future%20system" data-track="concepts_final_cta" className="inline-flex shrink-0 items-center gap-2 rounded-full bg-[#67e8f9] px-5 py-3 text-sm font-semibold text-[#06111f] transition-colors hover:bg-white">
